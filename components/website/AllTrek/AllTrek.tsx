...
function AllTrek({ region }: any) {
  ...
  return (
    <div className="w-full  py-[5rem]">
      {/* tab  */}
      <div className="sticky z-[2] top-[4.4rem] h-fit w-full mb-9  flex bg-white py-4 justify-start   items-center gap-10">
        {/* exp tab  */}
        {TrekData.map((item, index) => (
          <Link
            ...
            }  px-10 rounded-md py-2 whitespace-nowrap   shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] hover:scale-105 duration-300 cursor-pointer`}
          >
            <h1
