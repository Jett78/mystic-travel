...
const BlogDetails = () => {
  ...
  return (
    <div className=" w-10/12 mx-auto py-24">
      <h1 className="font-semibold text-[3vw] text-center font-palker tracking-wide mb-4">
        {title}
      </h1>
      ...
      <figure className="my-8">
        <Image
          ...
          width={1000}
          height={1000}
          className="w-full rounded-md h-[70vh] object-cover"
        />
      </figure>

      <div className="space-y-8 font-medium text-md text-zinc-800">
        <p>{description}</p>
        <p>{importance}</p>
        <p>{conclusion}</p>
      </div>
